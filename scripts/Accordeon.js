...
Accordeon.prototype.addClassDefault = function () {
  ...
  Array.from(this._element.children).forEach((element) =>
    element.classList.add(Accordeon.CLASS_ITEM)
  );
};
...
Accordeon.prototype.onClickItem = function (e) {
  if (e.target.classList.contains(Accordeon.CLASS_TITLE)) {
    ...
    Accordeon.hiddenBodyOnClick(this, e.target.nextElementSibling);
  }
};

Accordeon.hiddenBodyOnClick = function (listEl, targetEl) {
